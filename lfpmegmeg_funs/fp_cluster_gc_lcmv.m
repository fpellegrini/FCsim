function fp_cluster_gc_lcmv(DIROUT, alpha,fwf,j)
...
true_clu = permute(true_clu, [2,1,3,4]);
shuf_clu = permute(shuf_clu,[1, 3, 2, 4,5]);
...
%%
outname = sprintf('%sp_gc_lcmv_%s_%s_%s',DIROUT, alpha_s, fwf_s, j_s);
