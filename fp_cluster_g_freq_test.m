function [p, true_clu] = fp_cluster_g_freq_test(minnbchan,abs_imag,DIROUT)
...
outname = sprintf('%sp_cluster_g_freq_%s_test',DIROUT,abs_imag);
save(outname,'p','true_clu','true_total','true_p','-v7.3')