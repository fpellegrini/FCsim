function [p, true_clu] = fp_cluster_g_c_freq_test_0005_d(abs_imag, DIROUT)
...
%%
outname = sprintf('%sp_cluster_g_c_freq_%s_test0005_dics',DIROUT,abs_imag);
save(outname,'p','true_total','true_clu','true_p','true_testval','-v7.3')
