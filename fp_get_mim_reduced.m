function [mic, mim,to_save, mean_icoh, mean_acoh,t] = fp_get_mim_reduced(A,CS,fqA,nfqA, D,ihemi,mode1,zs,t)
...
if strcmp(mode1,'all')
    ...
    fprintf('baseline \n')
    tic
    [mic_b,mim_b,to_save_b,~] = fp_compute_mode_mim('baseline',D,[],[],A2,[],CS,fqA,nfqA,ihemi);
    t.bandc = toc;
