...
clear all
load('p_cluster_g_f_freq_imag_s_001__allsubs_d.mat')
...
%         a = true_testval';
        ...
        b = squeeze(sum(a,1));
        outname = sprintf('cluster_g_f_freq_imag_s_001__allsubs_d_%d.nii',iclus);
        ...
        outname1 = sprintf('cluster_g_f_freq_imag_s_001__allsubs_d_%d.png',iclus);
        print(outname1,'-dpng');
        close all
