...
for id = 1:numel(patientID)
    ...
    for iit = 1:1000
        ...
        [GC(:,:, iit),TRGC(:, :, iit)] = fp_shuffledGC(z,nmeg,n_trials,X,fres,id_meg_chan,...
            id_lfp_chan,nlfp,nfreq,ndim,ns,A_,nlags);
    end
...
function [GC, TRGC] = fp_shuffledGC(z,nmeg,n_trials,X,fres,id_meg_chan,id_lfp_chan,nlfp,nfreq,ndim,ns,A_,nlags)
