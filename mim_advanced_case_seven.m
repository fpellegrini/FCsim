...
for iroi_seed = 1:68
    for iroi_tar1 = 1:68
        clearvars -except mm_gt mc_gt bmm_gt bmc_gt GT MIM MIC iroi_seed iroi_tar1 IROI_TAR2
        
        iroi_tar2 = randi(68);
        IROI_TAR2(iroi_seed,iroi_tar1)=iroi_tar2;
        % ROI labels
        ...
        fres = 40;
        n_trials = 200;
        [signal_sensor,gt,L_save] = fp_generate_mim_signal2(iroi_seed,iroi_tar1,iroi_tar2, fres,n_trials, sub_ind_cortex, leadfield);
