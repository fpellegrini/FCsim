function [p, true_clu] = fp_cluster_g_freq_test_d(minnbchan,abs_imag,DIROUT)
...
outname = sprintf('%sp_cluster_g_freq_%s_test_dics',DIROUT,abs_imag);
save(outname,'p','true_clu','true_total','true_p','true_testval','-v7.3')